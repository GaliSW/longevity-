...
function App() {
  return (
    <>
      <div className="fixed right-0 top-0 animate-pulse-1 w-[60%] md:w-[60%] lg:w-[40%] md:absolute">
      ...
      <main>
        ...
        <footer className="flex flex-col gap-8 items-center bg-[#2C2C2C] p-10 w-full rounded-t-3xl lg:absolute md:bottom-0 z-999">
